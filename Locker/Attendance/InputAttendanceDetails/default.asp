...
<body topmargin=0>
    ...
    <form action="default.asp" method="post" name="default" id="default">
...
'                date_control local_date,local_date ,"default"
'            ELSE
'                date_control fromdate,todate ,"default"
'            END IF
      ...
      <table width="99%" class="sortable" id="customer_list" > 
        ...
        <tr>
        <td><a href="lockerAttendance.asp?lockerId=<%=rsLock("lockerId")%>"><%=rsLock("lockerNo")%></a>&nbsp;</td>
          <td><%=rsLock("accountNumber")%>&nbsp;</td>
          <td><%=rsLock("lockerHolderName")%>&nbsp;</td>
          <!--<td><%'=rsLock("lockerId")%></td>-->
    
          <td><a href="lockerAttendance.asp?lockerId=<%=rsLock("lockerId")%>">Detail</a>&nbsp;</td>
